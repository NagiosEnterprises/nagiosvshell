...
From within the vshell directory:
cd vshell
mkdir /usr/local/vshell
cp -r * /usr/local/vshell

To set up your apache configuration, modify the contents of the vshell.conf i
file to match the directory structure of your distribution and your 
installation of Nagios.  Use a text editor to modify this file as needed, then 
copy this file to the same directory as your nagios.conf file.  
...
/vshell/constants.inc.php file, which contains variables for the V-shell URL, 
...
changes are appropriate to the constants.inc.php file.  If errors occur after 
