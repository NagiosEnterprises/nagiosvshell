...
//NagiosUser.php  nagios user class to handle authorized hosts, services, and admin functionality 
...
class Nagios_user extends CI_Model {	
	...
	*	@var mixed $authHosts 
	*/ 
	protected static $authHosts = array(); //see below for array structure 
	/*
		$authHosts = 
