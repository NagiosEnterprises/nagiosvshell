...
// Note: the defined check makes it easier to define custom values for testing
if( ! defined('STATUSFILE') ){
     //status.dat file generated by nagios 
    define('STATUSFILE', $conf_file['STATUSFILE']);
}
if( ! defined('OBJECTSFILE') ){
    //main object configuration file generated by nagios
    define('OBJECTSFILE', $conf_file['OBJECTSFILE']);
}
